...
Codes of Section 3 (Exploratory Data Analysis)
```{r, fig.width=5}
...
```{r}
ind13.1 <- !is.na(wave5$depression) & !is.na(wave5$female)
p13.1 = ggplot(wave5[ind13.1,], aes(x = depression, fill = female)) + 
  geom_bar()
p13.1
```
...
## ci tests
ci.test("female", "education", test = "mi", data = wave5.fin)
ci.test("soc_con", "depression", test = "jt", data = wave5.fin)
ci.test("smoking", "depression", test = "jt", data = wave5.fin)
ci.test("smoking", "cogscore", test = "jt", data = wave5.fin)
ci.test("do_act", "bmi2", test = "jt", data = wave5.fin)
ci.test("drinking", "bmi2", test = "jt", data = wave5.fin)
ci.test("soc_con", "female", test = "mi", data = wave5.fin)
ci.test("depression", "cogscore", test = "jt", data = wave5.fin)
ci.test("smoking", "chronic_mod", test = "jt", data = wave5.fin)
ci.test("do_act", "chronic_mod", test = "jt", data = wave5.fin)
ci.test("bmi2", "cogscore", test = "jt", data = wave5.fin)
ci.test("age", "funscore", test = "jt", data = wave5.fin)
ci.test("female", "do_act", test = "mi", data = wave5.fin)
ci.test("age", "do_act", test = "jt", data = wave5.fin)
## white list
...
# wave5.pc =pc.stable(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.pc)
# wave5.gs =gs(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.gs)
# wave5.fiamb =fast.iamb(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.fiamb)
# wave5.int =inter.iamb(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.int)
# wave5.fdr =iamb.fdr(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.fdr)
# wave5.mmpc =mmpc(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.mmpc)
# wave5.si =si.hiton.pc(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.si)
# wave5.hpc =hpc(wave5.fin, whitelist = mywhitelist,blacklist = myblacklist)
# graphviz.plot(wave5.hpc)
## bn.fit
...
p1 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,1,,1,1,1]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Male, No education, No depression, No smoking")


p2 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,2,,1,1,1]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Female, No education, No depression, No smoking")

p3 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,1,,2,1,1]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Male, Primary education, No depression, No smoking")

p4 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,2,,2,1,1]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Female, Primary education, No depression, No smoking")
p5 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,1,,3,3,2]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Male, Gaodeng education, Depression 3, Smoking")


p6 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,2,,3,3,2]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Female, Gaodeng education, Depression 3, Smoking")

p7 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,1,,3,4,2]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Male, Gaodeng education, Depressed, Smoking")

p8 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,2,,3,4,2]), ncol =1), color = rep(levels(wave5.fin$cogscore), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Cognitive score", title ="Female, Gaodeng education, Depressed, Smoking")
...
# 3:cogscore 2:female 7:age 4: education 5:depression 4:bmi2 2:smoking
```
...
```{r}
bn.bayes2$cogscore$prob[,1,,1,1,1]
bn.bayes2$cogscore$prob[,1,,2,1,1]
bn.bayes2$cogscore$prob[,1,,3,1,1]
bn.bayes2$cogscore$prob[,1,,4,1,1]
# bn.bayes2$cogscore$prob[,1,,1,1,1][3,]/(bn.bayes2$cogscore$prob[,1,,1,1,1][2,]+bn.bayes2$cogscore$prob[,1,,1,1,1][1,])
# bn.bayes2$cogscore$prob[,1,,2,1,1][3,]/(bn.bayes2$cogscore$prob[,1,,2,1,1][2,]+bn.bayes2$cogscore$prob[,1,,2,1,1][1,])
# bn.bayes2$cogscore$prob[,1,,3,1,1][3,]/(bn.bayes2$cogscore$prob[,1,,3,1,1][2,]+bn.bayes2$cogscore$prob[,1,,3,1,1][1,])
# bn.bayes2$cogscore$prob[,1,,4,1,1][3,]/(bn.bayes2$cogscore$prob[,1,,4,1,1][2,]+bn.bayes2$cogscore$prob[,1,,4,1,1][1,])
```

```{r}
bn.bayes2$cogscore$prob[,2,,1,1,1]
bn.bayes2$cogscore$prob[,2,,2,1,1]
bn.bayes2$cogscore$prob[,2,,3,1,1]
bn.bayes2$cogscore$prob[,2,,4,1,1]
# bn.bayes2$cogscore$prob[,2,,1,1,1][3,]/(bn.bayes2$cogscore$prob[,2,,1,1,1][2,]+bn.bayes2$cogscore$prob[,1,,1,1,1][1,])
# bn.bayes2$cogscore$prob[,2,,2,1,1][3,]/(bn.bayes2$cogscore$prob[,2,,2,1,1][2,]+bn.bayes2$cogscore$prob[,2,,2,1,1][1,])
# bn.bayes2$cogscore$prob[,2,,3,1,1][3,]/(bn.bayes2$cogscore$prob[,2,,3,1,1][2,]+bn.bayes2$cogscore$prob[,1,,3,1,1][1,])
# bn.bayes2$cogscore$prob[,2,,4,1,1][3,]/(bn.bayes2$cogscore$prob[,2,,4,1,1][2,]+bn.bayes2$cogscore$prob[,2,,4,1,1][1,])
```

```{r}
(bn.bayes2$cogscore$prob[,2,,2,1,1] - bn.bayes2$cogscore$prob[,2,,1,1,1])/bn.bayes2$cogscore$prob[,2,,1,1,1]
```
...
```{r}
bn.bayes2$cogscore$prob[,1,,2,1,1]
bn.bayes2$cogscore$prob[,1,,2,2,1]
bn.bayes2$cogscore$prob[,1,,2,3,1]
bn.bayes2$cogscore$prob[,1,,2,4,1]
bn.bayes2$cogscore$prob[,1,,2,5,1]
```
```{r}
bn.bayes2$cogscore$prob[,2,,2,1,1]
bn.bayes2$cogscore$prob[,2,,2,2,1]
bn.bayes2$cogscore$prob[,2,,2,3,1]
bn.bayes2$cogscore$prob[,2,,2,4,1]
bn.bayes2$cogscore$prob[,2,,2,5,1]
```
...
```{r}
bn.bayes2$cogscore$prob[,1,,2,1,1]
bn.bayes2$cogscore$prob[,1,,2,1,2]
bn.bayes2$cogscore$prob[,1,,2,1,3]
bn.bayes2$cogscore$prob[,1,,2,1,4]
```

```{r}
(bn.bayes2$cogscore$prob[,2,,2,1,1][3,]-bn.bayes2$cogscore$prob[,2,,2,1,1][1,])/bn.bayes2$cogscore$prob[,2,,2,1,1][1,]
(bn.bayes2$cogscore$prob[,2,,2,1,2][3,]-bn.bayes2$cogscore$prob[,2,,2,1,2][1,])/bn.bayes2$cogscore$prob[,2,,2,1,2][1,]
(bn.bayes2$cogscore$prob[,2,,2,1,3][3,]-bn.bayes2$cogscore$prob[,2,,2,1,3][1,])/bn.bayes2$cogscore$prob[,2,,2,1,3][1,]
(bn.bayes2$cogscore$prob[,2,,2,1,4][3,]-bn.bayes2$cogscore$prob[,2,,2,1,4][1,])/bn.bayes2$cogscore$prob[,2,,2,1,4][1,]
...
```{r}
(bn.bayes2$cogscore$prob[,1,,2,1,1][,2]-bn.bayes2$cogscore$prob[,1,,2,1,1][,1])/bn.bayes2$cogscore$prob[,1,,2,1,1][,1]
(bn.bayes2$cogscore$prob[,1,,2,1,1][,3]-bn.bayes2$cogscore$prob[,1,,2,1,1][,2])/bn.bayes2$cogscore$prob[,1,,2,1,1][,2]
(bn.bayes2$cogscore$prob[,1,,2,1,1][,4]-bn.bayes2$cogscore$prob[,1,,2,1,1][,3])/bn.bayes2$cogscore$prob[,1,,2,1,1][,3]
(bn.bayes2$cogscore$prob[,1,,2,1,1][,5]-bn.bayes2$cogscore$prob[,1,,2,1,1][,4])/bn.bayes2$cogscore$prob[,1,,2,1,1][,4]
bn.bayes2$cogscore$prob[,1,,2,1,2]
bn.bayes2$cogscore$prob[,1,,2,1,3]
bn.bayes2$cogscore$prob[,1,,2,1,4]
```
...
```{r}
olr.fitn =polr(chronic_mod ~ age + bmi2 + do_act, data = wave5.fin[wave5.fin$smoking==0,])
olr.fits =polr(chronic_mod ~ age + bmi2 + do_act, data = wave5.fin[wave5.fin$smoking==1,])
c.lv = levels(wave5.fin$chronic_mod)
b.lv = levels(wave5.fin$bmi2)
age.lv = levels(wave5.fin$age)
do.lv = levels(wave5.fin$do_act)
s.lv = levels(wave5.fin$smoking)

combos = data.frame(
age=rep(age.lv, length(b.lv)),
bmi2=rep(b.lv,each = length(age.lv)),
do_act=rep(do.lv, each =
length(age.lv)*length(b.lv)))

distcsn = predict(olr.fitn, newdata= combos ,type="p")
distcss = predict(olr.fits, newdata= combos ,type="p")
distcs = array(dim = c(length(c.lv), length(age.lv), length(b.lv), length(do.lv), length(s.lv)), dimnames = list(chronic_mod = c.lv, age = age.lv, bmi2 = b.lv, do_act = do.lv, smoking = s.lv))
distcs[,,,,1] = array(t(distcsn), dim=c(length(c.lv), length(age.lv), length(b.lv), length(do.lv), 1))
distcs[,,,,2] = array(t(distcsn), dim=c(length(c.lv), length(age.lv), length(b.lv), length(do.lv), 1))

bn.bayes2$chronic_mod = distcs
...
```{r}
p25 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,2,1,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="BMI Normal, Do activities often, No smoking")
p26 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,2,2,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="BMI Normal, Do activities seldom, No smoking")
p27 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,2,3,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="BMI Normal, Never Do activities, No smoking")
grid.arrange(p25, p26, p27, nrow = 3)
```

0: healthy/no disease; 1: only one disease; 2: more than one disease

```{r, fig.width=5}
p28 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,1,1,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="Underweight, Do activities seldom, No smoking")
p29 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,2,1,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="Normal, Do activities seldom, No smoking")
p30 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,3,1,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="Overweight, Do activities seldom, No smoking")
p31 = ggplot(mapping = aes(x = rep(seq(1:length(levels(wave5.fin$age))),3),
                     y=matrix(t(bn.bayes2$chronic_mod$prob[,,4,1,1]), ncol =1), color = rep(levels(wave5.fin$chronic_mod), each = length(levels(wave5.fin$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(wave5.fin$age))),
        labels=levels(wave5.fin$age)) +
  labs(x = "Age", y= "Conditional probability", color = "Chronic Disease", title ="Obese, Do activities seldom, No smoking")
grid.arrange(p28, p29, p30, p31, nrow = 4)
```


```{r, fig.width=7}
bn.fit.barchart(bn.bayes$drinking)
```


```{r, fig.width=7}
bn.fit.barchart(bn.bayes$bmi2)
```


do more activities, more normal weight and less overweight and less obese.
drink more, different effects for people with different do_act levels.

```{r}
bn.fit.barchart(bn.bayes$depression)
```

lvse wei smoking, huangse wei xingbie

Smoking increases the probability of being level 4 for men, but not so obvious for women, only increases level 1. The most interesting thing is that depression more prevalent in women, women tends to have higher probability of high level depression
...
```{r, fig.width=7}
bn.fit.barchart(bn.bayes$soc_con)
```
suanle zhege buhao jieshi
```{r}
library(gRain)
junction = compile(as.grain(bn.bayes2))
```

```{r, fig.width=13}
graphviz.chart(bn.bayes2, grid = TRUE, main = "Original BN")
```
...
graphviz.chart(as.bn.fit(jf,including.evidence = TRUE), grid = TRUE, 
               bar.col = c(age = "black", female = "grey", education = "black", 
                           cogscore = "black", smoking = "black", depression = 
                          "black", drinking = "black", bmi2 = "black", do_act 
                        = "black", chronic_mod = "black", funscore = "black", 
                        soc_con = "black"),
              strip.bg = c(age = "transparent", female = "grey", education = "transparent",  cogscore = "transparent", smoking = "transparent", 
                           depression = 
                          "transparent", drinking = "transparent", bmi2 = "transparent", do_act 
                        = "transparent", chronic_mod = "transparent", funscore = "transparent", 
                        soc_con = "transparent"),
               main = "BN with Evidence")
```

```{r,fig.width=13}
jf2 = setEvidence(junction, nodes = "drinking", states = "1")
jf3 = setEvidence(junction, nodes = "drinking", states = "2")
jf4 = setEvidence(junction, nodes = "drinking", states = "3")
jf5 = setEvidence(junction, nodes = "drinking", states = "4")
graphviz.chart(as.bn.fit(jf2,including.evidence = TRUE), grid = TRUE, 
               bar.col = c(age = "black", female = "black", education = "black", 
                           cogscore = "black", smoking = "black", depression = 
                          "black", drinking = "grey", bmi2 = "black", do_act 
                        = "black", chronic_mod = "black", funscore = "black", 
                        soc_con = "black"),
              strip.bg = c(age = "transparent", female = "transparent", education = "transparent",  cogscore = "transparent", smoking = "transparent", 
                           depression = 
                          "transparent", drinking = "grey", bmi2 = "transparent", do_act 
                        = "transparent", chronic_mod = "transparent", funscore = "transparent", 
                        soc_con = "transparent"),
               main = "BN with Evidence, drinking 1")
```



```{r,fig.width=13}
graphviz.chart(as.bn.fit(jf3,including.evidence = TRUE), grid = TRUE, 
               bar.col = c(age = "black", female = "black", education = "black", 
                           cogscore = "black", smoking = "black", depression = 
                          "black", drinking = "grey", bmi2 = "black", do_act 
                        = "black", chronic_mod = "black", funscore = "black", 
              ...
              strip.bg = c(age = "transparent", female = "transparent", education = "transparent",  cogscore = "transparent", smoking = "transparent", 
                        ...
                        = "transparent", chronic_mod = "transparent", funscore = "transparent", 
                        soc_con = "transparent"),
               main = "BN with Evidence, drinking 2")

```


```{r,fig.width=13}
graphviz.chart(as.bn.fit(jf4,including.evidence = TRUE), grid = TRUE, 
               bar.col = c(age = "black", female = "black", education = "black", 
                           cogscore = "black", smoking = "black", depression = 
                          "black", drinking = "grey", bmi2 = "black", do_act 
                        = "black", chronic_mod = "black", funscore = "black", 
              ...
              strip.bg = c(age = "transparent", female = "transparent", education = "transparent",  cogscore = "transparent", smoking = "transparent", 
                        ...
                        = "transparent", chronic_mod = "transparent", funscore = "transparent", 
                        soc_con = "transparent"),
               main = "BN with Evidence, drinking 3")

```


```{r, fig.width=13}
graphviz.chart(as.bn.fit(jf5,including.evidence = TRUE), grid = TRUE, 
               bar.col = c(age = "black", female = "black", education = "black", 
                           cogscore = "black", smoking = "black", depression = 
                          "black", drinking = "grey", bmi2 = "black", do_act 
                        = "black", chronic_mod = "black", funscore = "black", 
              ...
              strip.bg = c(age = "transparent", female = "transparent", education = "transparent",  cogscore = "transparent", smoking = "transparent", 
                        ...
                        = "transparent", chronic_mod = "transparent", funscore = "transparent", 
                        soc_con = "transparent"),
               main = "BN with Evidence, drinking 4")
```
